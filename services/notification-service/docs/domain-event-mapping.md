...
| :--- | :--- | :--- | :--- | :--- |
| `com.rentagf.booking.BookingRequested.v1` | TRANSACTIONAL | `clientId` | Đang xử lý thanh toán ⏳ | Yêu cầu đặt lịch #{{bookingId}} của bạn đang chờ thanh toán. |
| `com.rentagf.booking.BookingReserved.v1` | TRANSACTIONAL | `companionId` | Yêu cầu mới! 🔔 | Bạn có một yêu cầu đặt lịch mới từ khách hàng. |
