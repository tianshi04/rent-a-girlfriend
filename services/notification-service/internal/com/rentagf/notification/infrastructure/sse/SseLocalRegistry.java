...
/**
 * Registry cục bộ quản lý Map in-memory chứa danh sách kết nối active SseEmitter. Đảm bảo Single
 * Responsibility Principle (SRP) bằng cách chỉ lo việc quản lý bộ nhớ cục bộ, hoàn toàn không chứa
 * dependency hạ tầng hay nghiệp vụ đồng bộ nào.
 */
@Component
