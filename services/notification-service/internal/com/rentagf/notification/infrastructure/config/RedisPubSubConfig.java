...
/**
 * Cấu hình hạ tầng Redis Pub/Sub thời gian thực. Tối ưu hóa Threading bằng cách cho phép Redis
 * Message Listener hoạt động trên Virtual Threads.
 */
@Configuration
public class RedisPubSubConfig {
  ...
  /**
   * Khởi tạo container quản lý các kết nối lắng nghe Redis Pub/Sub. Cấu hình sử dụng
   * SimpleAsyncTaskExecutor chạy trên Java 21 Virtual Threads giúp giải phóng tối đa Platform
   * Threads khi nhận tin nhắn phân phối.
   */
  @Bean
