...
/**
 * Cấu hình khởi tạo TemplateEngine tải file templates.yaml. Hỗ trợ tải động từ classpath trong cả
 * môi trường local và đóng gói jar chạy thật.
 */
@Configuration
public class TemplateConfig {
  ...
  public TemplateEngine templateEngine(
      NotificationProperties notificationProperties, ResourceLoader resourceLoader) {
    ...
    if (!resource.exists()) {
      throw new IllegalArgumentException(
          "Templates configuration file not found at: " + templatesPath);
    }
    ...
    try (InputStream inputStream = resource.getInputStream()) {
      ...
      throw new IllegalStateException(
          "Failed to read templates configuration from " + templatesPath, e);
    }
  }
}
