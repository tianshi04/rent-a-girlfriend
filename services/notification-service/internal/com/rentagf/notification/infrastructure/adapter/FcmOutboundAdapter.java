...
/**
 * Adapter hạ tầng gửi Push Notification qua Firebase Cloud Messaging (FCM). Tích hợp Firebase Admin
 * SDK chính thức. Hỗ trợ chế độ mô phỏng chi tiết (Simulation Mode) nếu ứng dụng khởi chạy không có
...
public class FcmOutboundAdapter implements FcmPort {
  ...
  public SendResult send(Notification notification) {
    ...
    try {
      ...
      // Lỗi FCM API có thể là recoverable (timeout, rate limit) hoặc unrecoverable (sai token,
      // credential hết hạn)
