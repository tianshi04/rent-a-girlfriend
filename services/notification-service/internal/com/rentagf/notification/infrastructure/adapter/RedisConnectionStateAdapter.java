...
/**
 * Adapter triển khai ConnectionStatePort sử dụng Redis làm Connection State Store. Quản lý trạng
 * thái Online/Offline phân tán bằng cách lưu trữ String key trên Redis.
 */
@Component
