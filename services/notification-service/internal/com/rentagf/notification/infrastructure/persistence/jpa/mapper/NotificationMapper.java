...
public class NotificationMapper {
  ...
  public NotificationJpaEntity toJpaEntity(Notification domain) {
    ...
    if (domain.getAttempts() != null) {
      List<DeliveryAttemptJpaEntity> attemptJpaEntities =
          domain.getAttempts().stream()
  ...
  public Notification toDomain(NotificationJpaEntity jpaEntity) {
    ...
    if (jpaEntity.getAttempts() != null) {
      domainAttempts =
          jpaEntity.getAttempts().stream().map(this::toAttemptDomain).collect(Collectors.toList());
    }
  ...
  private DeliveryAttemptJpaEntity toAttemptJpaEntity(
      DeliveryAttempt attempt, NotificationJpaEntity notificationJpaEntity) {
    if (attempt == null) {
      return null;
    }
