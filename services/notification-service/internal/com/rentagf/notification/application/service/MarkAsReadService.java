...
/**
 * Service triển khai Use Case MarkAsReadUseCase. Tận dụng Optimistic Update từ Repository để tối ưu
 * hóa IO và ngăn chặn IDOR/BOLA.
 */
@Service
...
public class MarkAsReadService implements MarkAsReadUseCase {
  ...
  public void markAsRead(UUID notificationId, UUID userId) {
    ...
    if (!success) {
      // Nếu trả về false: chứng tỏ thông báo không tồn tại hoặc không thuộc quyền sở hữu của user
      // (ngăn BOLA)
