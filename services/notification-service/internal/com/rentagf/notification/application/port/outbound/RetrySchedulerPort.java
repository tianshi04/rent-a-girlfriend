...
/**
 * Port Outbound định nghĩa giao diện lên lịch gửi lại thông báo trì hoãn (Retry). Đây là
 * abstraction cốt lõi để cô lập hạ tầng Retry (In-Memory, Kafka, RabbitMQ) khỏi Domain Logic.
 */
