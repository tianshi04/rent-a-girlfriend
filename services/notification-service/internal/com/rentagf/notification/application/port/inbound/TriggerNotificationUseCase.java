...
/**
 * Inbound Port (UseCase) định nghĩa nghiệp vụ gửi thông báo thủ công qua kênh chỉ định sẵn. Đảm bảo
 * tính tách biệt trách nhiệm (Single Responsibility Principle) hoàn hảo.
 */
