 ...
 *
 * <ul>
 *   <li>KHÔNG làm: parse JSON, translate CloudEvent → đó là việc của Inbound Adapter
 *       (KafkaEventConsumer).
 *   <li>CHỈ LÀM: kiểm tra Idempotency + định tuyến thông minh từng Notification qua
 *       SendNotificationUseCase.
 * </ul>
 *
 * Thiết kế này đảm bảo Application Layer hoàn toàn độc lập với Interfaces Layer (Hexagonal
 * Architecture RULE 4).
 */
