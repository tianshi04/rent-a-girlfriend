...
/**
 * Resolver đặc thù cho sự kiện giải quyết khiếu nại (DisputeResolved). Cần gửi thông báo cho cả 2
 * bên (Client và Companion).
 */
@Component
public class DisputeResolvedResolver implements RecipientResolver {
  ...
  public boolean supports(String eventType) {
    return "dispute.dispute-resolved.v1".equals(eventType);
  }
}
