...
/**
 * Registry đóng vai trò điều phối (Orchestrator) việc phân giải người nhận. Áp dụng Design Pattern:
 * Registry + Strategy + Ultimate Fallback.
 */
@Component
public class RecipientResolverRegistry {
  ...
  /**
   * @param strategyResolvers Tự động inject tất cả các class implements RecipientResolver. Spring
   *     sẽ bỏ qua SimpleRecipientResolver vì nó không implement interface này.
   * @param simpleFallbackResolver Kẻ hứng đáy (Fallback) cho các event thông thường.
   */
  public RecipientResolverRegistry(
      List<RecipientResolver> strategyResolvers, SimpleRecipientResolver simpleFallbackResolver) {
