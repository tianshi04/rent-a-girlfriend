 ...
 * Áp dụng triệt để nguyên lý Fail-Fast: Ném Exception ngay khi thiếu tham số cần thiết trong
 * payload.
 */
public class TemplateEngine {
  ...
  /**
   * Dịch và ráp tham số cho tiêu đề hoặc nội dung thông báo. Mặc định Phase 3 chỉ hỗ trợ tiếng Việt
   * ("vi").
   *
  ...
  public String render(String eventType, Map<String, Object> data, boolean isTitle) {
    ...
    if (rawText == null) {
      throw new IllegalStateException(
          "Missing template text for event: " + eventType + " (isTitle: " + isTitle + ")");
    }
  ...
  /**
   * Thực hiện thay thế các placeholder {{var}} bằng giá trị thực tế trong data. Áp dụng FAIL-FAST:
   * Nếu thiếu biến, ném IllegalArgumentException lập tức.
   */
