...
/**
 * Interface chiến lược (Strategy Pattern) để phân giải người nhận từ Event Data. Giúp hệ thống dễ
 * dàng mở rộng thêm các logic phân giải người nhận mới mà không cần chỉnh sửa mã nguồn hiện tại
...
public interface RecipientResolver {
   ...
   * @param recipientField Trường người nhận tĩnh (từ template, có thể bị ignore bởi các strategy
   *     động).
