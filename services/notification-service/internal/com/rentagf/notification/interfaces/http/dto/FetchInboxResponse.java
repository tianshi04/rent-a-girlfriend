 ...
 */
public record FetchInboxResponse(
    ...
    /**
     * Khởi tạo FetchInboxResponse từ danh sách thông báo.
     * Hỗ trợ tự động cắt bớt phần tử thừa (phần tử thứ limit + 1) và tính toán nextCursor.
     *
