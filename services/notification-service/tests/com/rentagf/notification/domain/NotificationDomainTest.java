...
class NotificationDomainTest {
    ...
    void testInitialNotificationState() {
        Notification notification = Notification.create(userId, eventId, NotificationType.TRANSACTIONAL, NotificationPriority.HIGH, payload, Map.of());
    ...
    void testMarkAttemptFailedUnrecoverable() {
        ...
        notification.markAttemptFailed(attempt.getId(), "FCM_TOKEN_INVALID", "FCM token is expired or invalid", false);
    ...
    void testMarkAttemptFailedRecoverableKeepProcessing() {
        ...
        notification.markAttemptFailed(attempt.getId(), "SMTP_TIMEOUT", "SMTP connection timed out", true);
    ...
    void testInvariantN01MaxRetriesExceeded() {
        ...
        assertThrows(RetryLimitExceededException.class, () -> notification.createAttempt(DeliveryChannel.EMAIL));
    }
    ...
    void testInvariantN02CannotAttemptAfterCompleted() {
        ...
        assertThrows(NotificationAlreadyCompletedException.class, () -> notification.createAttempt(DeliveryChannel.FCM));
    }
}
