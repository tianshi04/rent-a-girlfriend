 ...
 *
 * <p>Mock các bean hạ tầng ngoài (Redis, Mail) để test có thể chạy mà không cần kết nối thực tế.
 */
@SpringBootTest
class NotificationServiceApplicationTests {
  ...
  /**
   * Thay thế RedisPubSubAdapter – StringRedisTemplate + RedisMessageListenerContainer bị exclude
   * trong test.
   */
