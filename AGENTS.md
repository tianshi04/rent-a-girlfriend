...
- **Secret Management**: Sử dụng External Secrets Operator (ESO) kết hợp với External HashiCorp Vault. Xem chi tiết tại `docs/06_DevOps_and_CI_CD/04_secret_management_standards.md`.
