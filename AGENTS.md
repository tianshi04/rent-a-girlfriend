...
- **Secret Management**: Use External Secrets Operator (ESO) integrated with external HashiCorp Vault. For detailed guidelines, refer to `docs/06_DevOps_and_CI_CD/04_secret_management_standards.md`.
